...
title: "Charlas"
url: /es/talks/
summary: "Charlas y talleres sobre Linux, el kernel, código abierto y crecimiento profesional."
ShowToc: false
hidemeta: true
...
Doy charlas sobre Linux, desarrollo del kernel, la comunidad de código abierto y el crecimiento como desarrollador. Si quieres que hable en tu evento, contáctame por [Sessionize](https://sessionize.com/lfhernandez/) o [LinkedIn](https://www.linkedin.com/in/lf-hernandez/).
...
El Linux Kernel Mentorship Program fue más que una oportunidad de contribuir al código abierto. Fue un punto de inflexión en mi carrera y crecimiento técnico. Cómo el programa me ayudó a conseguir un rol, devolver a la comunidad de Linux y participar más activamente en mi comunidad local organizando, mentorando y enseñando.

**In The Deep End: My Experience as a Linux Kernel Mentee**
Contribuir al kernel de Linux desde la perspectiva de un mentee, con foco en el Linux Kernel Mentorship Program de la Linux Foundation y las oportunidades que abre.

## Talleres

Talleres prácticos que he dado para [Orlando Devs](https://orlandodevs.com/) y Orlando DevOps:

- Estrategias de branching en Git
- Código abierto y el kernel de Linux
